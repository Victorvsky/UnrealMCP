        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "max_actors": {"type": "integer", "minimum": 0, "description": "Cap on the visible-actor list (nearest first)."},
                    "debug": {"type": "boolean", "description": "Also return `culled`: every skipped actor with the reason (no_rendered_mesh, behind_camera, off_screen, occluded_by:<actor>)."},
                },
            },
        ),
    ]
